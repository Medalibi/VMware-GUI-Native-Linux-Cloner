...
################################################################################################################################################################################################################
        ...
        foreach ($Idline in $GPUsIdslist)
      {
       ...
       {
        $outputBox.AppendText("`r`n[DEBUG] This option is still under maintenance.`r`n`r`n")
        Write-Host -ForeGroundColor Yellow "`n[DEBUG] This option is still under maintenance.`n"
        $operationloop = $i
       }
